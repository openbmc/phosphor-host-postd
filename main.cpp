...
int postCodeIpmiHandler(std::string snoopObject, std::string snoopDbus,
                        sdbusplus::bus::bus& bus, std::vector<std::string>& host)
{
    int ret = 0;
    ...
    try
    {
        ...
        {
            auto objPathInst = snoopObject + host[iteration];
